...
let modelDerivativeRouter = express.Router();

// Middleware for obtaining a token for each request.
modelDerivativeRouter.use(async (req, res, next) => {
...
modelDerivativeRouter.post('/jobs', async (req, res, next) => {
...
export default modelDerivativeRouter
